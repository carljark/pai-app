export const TRANSLATIONS_CA = {
  ...
  generatorExtraInstructionsPlaceholder: 'Ex: Enfocar les activitats en la cura del medi ambient, incloure dinàmiques amb eines digitals com Canva, o adaptar per a alumnat amb dificultats de comprensió lectora...',
